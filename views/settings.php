    ...
    <div id="poststuff">
        <div id="post-body" class="metabox-holder columns-1">
            ...
            <!--<div class="postbox-container">                
                <div class="postbox">                    
                    <div class="meta-box-sortables">
                        <h2 class="hndle"><span>Threat Detection</span></h2>
                        <div class="inside">
                            <table class="form-table">
                                <tbody>
                                    <form action="<?php echo TSIPBlocker\Util::getAdminPostUrl(); ?>" method="post">
                                        <input type="hidden" name="action" value="ts_ip_blocker_update_thread_detection_settings">
                                        <tr>
                                            <th scope="row">Enabled</th>
                                            <td><input type="checkbox"></td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Google Safe Browsing API Key</th>
            ...
            <div class="postbox-container">                
                <div class="postbox">                    
                    <div class="meta-box-sortables">
                        <h2 class="hndle"><span>Geolocation</span></h2>
                        <div class="inside">
                            <table class="form-table">
                                <tbody>
                                    <form action="<?php echo TSIPBlocker\Util::getAdminPostUrl(); ?>" method="post">
                                        <input type="hidden" name="action" value="ts_ip_blocker_update_geolocation_settings">
                                        <tr>
                                            <th scope="row">Enabled</th>
                                            <td><input type="checkbox"></td>
                                        </tr>
            ...
            <p>
                <a href="#" id="adv-settings-toggle">Show Advanced Settings</a>
            </p>
